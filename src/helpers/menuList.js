...
export const menuList = [
  ...
  { key: 4, name: "Sicilian Pizza", info: "Adding oil to the pan also helps to make the base of the dough a bit crispier", review: 188, price: 16.9, image: { SicilianPizza } },
  { key: 5, name: "Greek Pizza", info: "unique flavor has to do with the minerals present in New York’s tap water supply.", review: 244, price: 19.9, image: { GreekPizza } },
  { key: 6, name: "California Pizza", info: "California Pizza pizza usually features tomato sauce and mozzarella cheese. ", review: 542, price: 14.9, image: { CaliforniaPizza } },
